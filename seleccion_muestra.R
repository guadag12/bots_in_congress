...
write.csv(muestra_2016, "muestra_2016", row.names = F) #guardamos nuestra muestra en un csv para procesarlo en Python 
...
write.csv(muestra_2020, "muestra_2020", row.names = F) #guardamos nuestra muestra en un csv para procesarlo en Python 